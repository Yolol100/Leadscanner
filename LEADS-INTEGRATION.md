...
Generic discovery, signal evidence en source discovery blijven bounded evidence-capabilities buiten de filterpolicy. Actieve advertenties en inactieve officiële socials zijn alleen discovery-prioriteit. Ze bewijzen geen budget, pijn of urgentie. Een ontbrekende/beschadigde `llms.txt` is geen zelfstandig bewijs voor Google/AI-zichtbaarheid. `src/tools/prospect-signal-policy.mjs` houdt deze grenzen generiek en fail-closed.
